                    ...
                    <div className='flex justify-center items-center'>
                        <form className='flex flex-col w-full md:w-1/2' action='https://getform.io/f/74ad5221-7a7b-42b2-a738-367c384dd666' method='POST'>
                            ...
                            <input type='email' name='email' placeholder='Enter Email'
                                className='p-2 bg-transparent border-2 rounded-md text-white focus:outline-none my-4' required/>
                            ...
                            <textarea type='text' name='message' rows={10} placeholder='Enter your message'
                                ...
                                mx-auto flex items-center rounded-md hover:scale-110 duration-300 cursor-pointer'>Let's Talk</button>
