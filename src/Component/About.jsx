...
function About(props) {
    return (
        <div name='about' className='h-auto  w-full bg-gradient-to-t from bg-gray-800 to-black text-white' >
            ...
            <div className=' max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full pb-20  '>
                ...
                <div className='flex h-full text-justify flex-col px-8'>
                    {/* <div className=''> */}
                        <img src={webdev} alt='image' className=' w-full h-2/4 lg:h-96  hover:scale-105 duration-500 
